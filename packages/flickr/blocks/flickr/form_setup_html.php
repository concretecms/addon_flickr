...
<table id="FlickrSetup" width="100%">
	...
	<tr>
		...
		<td style="padding-top: 5px"><input id="ccm_flickr_title" name="title" value="<?php echo $controllerObj->title?>" maxlength="255" type="text" style="width:100%"></td>
	</tr>	
	<tr>
		<th><?php echo t('Number of images to display')?>:</th>
		<td style="padding-top: 5px"><input id="ccm_flickr_itemsToDisplay"  name="itemsToDisplay" value="<?php echo intval($controllerObj->itemsToDisplay)?>" type="text" size="2" maxlength="3"></td>
	</tr>
	<tr>
